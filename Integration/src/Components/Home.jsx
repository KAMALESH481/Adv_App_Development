...
const Home = ({displayName}) => {
  ...
  <>
    ...
    <Link to="/pro"><div style={{color:"black"}}>Profile</div></Link>
    <Link to="/CreateYourResume" ><div style={{color:"black"}}>Job Details</div></Link>
    <Link to="/TrendJobs"><div style={{color:"black"}}>Job Openings</div></Link>
    <Link to="/Hack" style={{color:"black"}}><div>Hackathons</div></Link>
    </div>
    </div>
